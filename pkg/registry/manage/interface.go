...
type Interface interface {
	...
	GetConnectionStatus(sn string) (local string, remote string, err error)
...
func (*NoopInterface) GetConnectionStatus(sn string) (local string, remote string, err error) {
